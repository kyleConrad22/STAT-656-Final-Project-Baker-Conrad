...
The data sets, `tissue_chn` and `tissue_icp`, both contain measurements that would not be useful for determining the affect of fertilizer application on plant growth. They would be response variables similar to total plant growth observed, therefore both data sets will be disregarded. 
```{r, echo =FALSE}
rm(tissue_chn, tissue_icp)
```
